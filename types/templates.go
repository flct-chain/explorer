...
// TransactionDataApiResponse is a struct to hold data for transaction responses
type TransactionDataApiResponse struct {
	Data        []interface{} `json:"data"`
	PagingToken string        `json:"pagingToken"`
}

// Erc20TransactionDataApiResponse is a struct to hold data for transaction responses
type Erc20TransactionDataApiResponse struct {
	Data        []interface{} `json:"data"`
	PagingToken string        `json:"pagingToken"`
}
