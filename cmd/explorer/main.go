...
func main() {
	...
	if cfg.Frontend.Enabled {
		...
		apiV1Router.HandleFunc("/address/{address}/transactions", handlers.Eth1AddressTransactionsApi).Methods("GET")
		apiV1Router.HandleFunc("/address/{address}/erc20_transactions", handlers.Eth1AddressErc20TransactionsApi).Methods("GET")
